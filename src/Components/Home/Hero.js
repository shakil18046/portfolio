        ...
        <div className='hero-area'>
            ...
            <div className='hero-grid'>
                <div className='hero-content-wrapper' data-aos="fade-right" data-aos-duration="2000">
                    ...
                    <p className='paragraph pt-2 pb-2'>Frontend Developer based in Bangladesh with a deep passion for building rich, engaging user experiences that make people's lives better.</p>
